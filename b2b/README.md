...
4. Whole-set controls live in the crate: **Suggest set order** displays the proposed sequence; **Play crate set** orders compatible tracks and starts from the first track. Tracks outside the plan stay in the crate.
